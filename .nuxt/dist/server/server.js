...
/******/ 			var chunk = require("./" + ({"1":"pages/index","2":"pages/index/article","3":"pages/index/article/_slug","4":"pages/index/article/components/article-comment","5":"pages/index/article/components/article-meta","6":"pages/index/index","7":"pages/index/login","8":"pages/index/mkarticle","9":"pages/index/profile","10":"pages/index/profile/_username","11":"pages/index/setting"}[chunkId]||chunkId) + ".js");
...
/* harmony default export */ __webpack_exports__["a"] = (({
  ...
  request.interceptors.request.use(config => {
    ...
    !Object(_utils__WEBPACK_IMPORTED_MODULE_1__[/* isUndef */ "b"])(user) && (config.headers.Authorization = `Token ${user.token}`);
    return config;
  }, err => {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "COMMIT_GETUSER", function() { return COMMIT_GETUSER; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "COMMIT_SETUSER", function() { return COMMIT_SETUSER; });
const GETUSER = 'getUser';
const SETUSER = 'setUser';
const COMMIT_GETUSER = `user/${GETUSER}`;
const COMMIT_SETUSER = `user/${SETUSER}`;
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return isUndef; });
...
const isUndef = target => isNull(target) || isUndefined(target);
const isDef = target => !isNull(target) && !isUndefined(target);
const isEmptyObject = target => Object.keys(target).length === 0;
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return getProfile; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return followHandler; });
...
const currentUser = (method = 'GET', data) => {
  const config = {
    method,
    url: '/user'
  };
...
const followHandler = (type, username) => {
  return Object(_plugins_request__WEBPACK_IMPORTED_MODULE_0__[/* request */ "b"])({
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _store_actionTypes__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  actions: {
    nuxtServerInit({
      ...
      if (!Object(_utils__WEBPACK_IMPORTED_MODULE_1__[/* isUndef */ "b"])(parsed.USER)) {
        try {
          commit(_store_actionTypes__WEBPACK_IMPORTED_MODULE_0__["COMMIT_SETUSER"], JSON.parse(parsed.USER));
        } catch (err) {
          console.dir(err);
        }
      }
...
/* harmony import */ var _api_users__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(10);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mutations: {
    async [_actionTypes__WEBPACK_IMPORTED_MODULE_0__["GETUSER"]](state) {
      const {
        data
      } = await Object(_api_users__WEBPACK_IMPORTED_MODULE_1__[/* currentUser */ "b"])();
      const {
        user
      } = data;
      this.commit(_actionTypes__WEBPACK_IMPORTED_MODULE_0__["COMMIT_SETUSER"], user);
    },

    [_actionTypes__WEBPACK_IMPORTED_MODULE_0__["SETUSER"]](state, user) {
      state.user = user;
    }
...
middleware['noslug'] = __webpack_require__(21);
middleware['noslug'] = middleware['noslug'].default || middleware['noslug'];
middleware['notAuthenticated'] = __webpack_require__(22);
...
const _218afa32 = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 1).then(__webpack_require__.bind(null, 35)));

const _72d10fbb = () => interopDefault(__webpack_require__.e(/* import() | pages/index/index */ 6).then(__webpack_require__.bind(null, 36)));

const _2271f19f = () => interopDefault(__webpack_require__.e(/* import() | pages/index/article */ 2).then(__webpack_require__.bind(null, 37)));

const _eac70dba = () => interopDefault(__webpack_require__.e(/* import() | pages/index/article/components/article-comment */ 4).then(__webpack_require__.bind(null, 33)));

const _30a91df1 = () => interopDefault(__webpack_require__.e(/* import() | pages/index/article/components/article-meta */ 5).then(__webpack_require__.bind(null, 34)));

const _25b8fe8a = () => interopDefault(__webpack_require__.e(/* import() | pages/index/article/_slug */ 3).then(__webpack_require__.bind(null, 38)));

const _3c78b2d2 = () => interopDefault(__webpack_require__.e(/* import() | pages/index/login */ 7).then(__webpack_require__.bind(null, 39)));

const _6f78d501 = () => interopDefault(__webpack_require__.e(/* import() | pages/index/mkarticle */ 8).then(__webpack_require__.bind(null, 40)));

const _0777c65c = () => interopDefault(__webpack_require__.e(/* import() | pages/index/profile */ 9).then(__webpack_require__.bind(null, 41)));

const _179dbc53 = () => interopDefault(__webpack_require__.e(/* import() | pages/index/profile/_username */ 10).then(__webpack_require__.bind(null, 42)));

const _2b38140e = () => interopDefault(__webpack_require__.e(/* import() | pages/index/setting */ 11).then(__webpack_require__.bind(null, 43)));
...
(function updateModules() {
  ...
  resolveStoreModules(__webpack_require__(3), 'actionTypes.js');
  resolveStoreModules(__webpack_require__(29), 'user.js'); // If the environment supports hot reloading...
})(); // createStore
...
var external_dayjs_ = __webpack_require__(18);
var external_dayjs_default = /*#__PURE__*/__webpack_require__.n(external_dayjs_);

// CONCATENATED MODULE: ./plugins/dayjs.js


external_vue_default.a.filter('dateFormatter', (date, format = 'MMM D, YYYY') => {
